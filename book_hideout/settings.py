"""
Django settings for book_hideout project.
...
ROOT_URLCONF = 'book_hideout.urls'
...
WSGI_APPLICATION = 'book_hideout.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    AWS_STORAGE_BUCKET_NAME = 'ci-pp5-book-hideout'
